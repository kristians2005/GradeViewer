...
<div class="container mx-auto p-4">
    ...
    <div class="card bg-base-100 shadow-xl" data-aos="fade-up" data-aos-delay="200">
        <div class="card-body">
            ...
            <!-- Filter Section -->
            <div class="flex flex-col md:flex-row gap-4 mb-6" data-aos="fade-up" data-aos-delay="250">
                <div class="form-control flex-1">
                    <div class="input-group">
                        <input type="text" id="classSearch" placeholder="Search classes..." class="input input-bordered w-full" />
                ...
                <div class="form-control">
                    <select id="sortClasses" class="select select-bordered">
